...
import harbour.opentip.SailfishWidgets.Components 3.3
import harbour.opentip.SailfishWidgets.Settings 3.3
import harbour.opentip.SailfishWidgets.Language 3.3
...
OrientationPage {
    ...
    PageColumn {
        title: qsTr("Settings")
        Subtext {text: qsTr("Rounding")}
        TextSwitch {
            checked: settings.roundUp
            id: swipe
            text: qsTr("Round tips up")

            onCheckedChanged: settings.roundUp = checked
        }
